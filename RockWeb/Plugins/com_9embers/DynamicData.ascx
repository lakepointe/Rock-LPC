<%@ Control Language="C#" AutoEventWireup="true" CodeFile="DynamicData.ascx.cs" Inherits="RockWeb.Plugins.com_9embers.Reporting.DynamicData" %>
...
<asp:UpdatePanel ID="upnlContent" runat="server" ChildrenAsTriggers="false" UpdateMode="Conditional">
    <ContentTemplate>
        ...
        <asp:Panel ID="pnlView" runat="server">
            ...
            <Rock:NotificationBox ID="nbAlert" runat="server" NotificationBoxType="Danger" Visible="false" />
                        ...
                        <ContentTemplate>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <Rock:Switch ID="cbEnablePaging" runat="server" Text="Enable Paging" TextAlign="Right" />
                                ...
                                <div class="col-md-6">
                                    ...
                                    <Rock:KeyValueList ID="kvlActions" runat="server" Label="Custom Actions" KeyPrompt="Action" ValuePrompt="Url" Help="List of custom actions to display. When an action is selected, this block will create an EntitySet and include append an EntitySetId=# query parameter to the specified URL." />
                                </div>
                            </div>

                           <div class="row js-wrap-in-panel">
                                <div class="col-md-6">
                                    <Rock:RockTextBox ID="tbPanelTitle" runat="server" Label="Panel Title" Help="The title to display for each panel. Lava is supported. For example if 'Title' column exists in each table: {% assign rows = tables[TableNumber].rows | Size %}{% if rows > 0 %}{{ tables[TableNumber].rows[0].Title }}{% endif %}" />
                                </div>
                                <div class="col-md-6">
                            ...
                            <Rock:PanelWidget CssClass="mt-4" runat="server" ID="pwAdvancedSettings" Title="Advanced Settings">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
	                                    <Rock:RockTextBox ID="tbNumericFields" runat="server" Label="Numeric Fields" TextMode="MultiLine" Rows="1" CssClass="input-xlarge"
	                                        Help="Any fields that should be displayed as numeric values (right aligned)." />
	                                    <Rock:RockTextBox ID="tbCurrencyFields" runat="server" Label="Currency Fields" TextMode="MultiLine" Rows="1" CssClass="input-xlarge"
	                                        Help="Any fields that should be displayed as a currency value." />
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
